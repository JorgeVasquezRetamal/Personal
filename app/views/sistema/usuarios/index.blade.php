			  			...
			  			<tr>
			  				...
			  				<td>
			  					...
			  					@if($user_act->estado=='Activo')
			  						<a href="{{ action('sistema\UsersController@getDesactive', array($user_act->id)) }}" class="btn btn-xs btn-default"><i class="fa fa-times"></i> Desactivar</a>
			  					@else
			  						<a href="{{ action('sistema\UsersController@getActive', array($user_act->id)) }}" class="btn btn-xs btn-default"><i class="fa fa-check"></i> Activar</a>
			  					@endif
			  				</td>
		  		...
		  		<tbody>
		  			@foreach($users_inact as $user_inact)
			  			<tr>
			  				...
			  				<td>
			  					<a href="{{ action('sistema\UsersController@getEdit', array($user_inact->id)) }}" class="btn btn-xs btn-default"><i class="fa fa-edit"></i> Editar</a>
			  					<a href="{{ action('sistema\UsersController@getVer', array($user_inact->id)) }}" class="btn btn-xs btn-default"><i class="fa fa-eye"></i> Ver</a>
			  					@if($user_inact->estado=='Activo')
			  						<a href="{{ action('sistema\UsersController@getDesactive', array($user_inact->id)) }}" class="btn btn-xs btn-default"><i class="fa fa-times"></i> Desactivar</a>
			  					@else
			  						<a href="{{ action('sistema\UsersController@getActive', array($user_inact->id)) }}" class="btn btn-xs btn-default"><i class="fa fa-check"></i> Activar</a>
			  					@endif
			  				</td>
